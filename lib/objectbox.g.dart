...
import 'package:ibaza/features/card/card.dart';
...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 8867898189414859820),
      name: 'SavedCard',
      lastPropertyId: const IdUid(2, 5554762485964086346),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2793698917448171630),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5554762485964086346),
            name: 'name',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 8867898189414859820),
